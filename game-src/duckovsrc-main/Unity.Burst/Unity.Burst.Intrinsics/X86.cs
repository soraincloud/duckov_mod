...
public static class X86
{
	...
	internal delegate void DoSetCSRTrampoline_0000012A_0024PostfixBurstDelegate(int bits);

	internal static class DoSetCSRTrampoline_0000012A_0024BurstDirectCall
	{
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(DoSetCSRTrampoline_0000012A_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		static DoSetCSRTrampoline_0000012A_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	internal delegate int DoGetCSRTrampoline_0000012B_0024PostfixBurstDelegate();

	internal static class DoGetCSRTrampoline_0000012B_0024BurstDirectCall
	{
		private static IntPtr Pointer;
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(DoGetCSRTrampoline_0000012B_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		static DoGetCSRTrampoline_0000012B_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	{
		DoSetCSRTrampoline_0000012A_0024BurstDirectCall.Invoke(bits);
	}

	[BurstCompile(CompileSynchronously = true)]
	private static int DoGetCSRTrampoline()
	{
		return DoGetCSRTrampoline_0000012B_0024BurstDirectCall.Invoke();
	}
