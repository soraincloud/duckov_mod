...
public static class BurstCompiler
{
	...
	internal static class BurstCompilerHelper
	{
		...
		internal delegate bool IsBurstEnabled_00000146_0024PostfixBurstDelegate();

		internal static class IsBurstEnabled_00000146_0024BurstDirectCall
		{
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(IsBurstEnabled_00000146_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static IsBurstEnabled_00000146_0024BurstDirectCall()
			{
				Constructor();
			}
		...
		{
			return IsBurstEnabled_00000146_0024BurstDirectCall.Invoke();
		}
	...
	public static void Initialize_0024BurstCompilerHelper_IsBurstEnabled_00000146_0024BurstDirectCall()
	{
		BurstCompilerHelper.IsBurstEnabled_00000146_0024BurstDirectCall.Initialize();
	}
}
