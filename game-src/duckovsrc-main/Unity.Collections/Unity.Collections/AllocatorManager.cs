...
public static class AllocatorManager
{
	...
	internal struct StackAllocator : IAllocator, IDisposable
	{
		...
		internal static class Try_000000AB_0024BurstDirectCall
		{
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(Try_000000AB_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static Try_000000AB_0024BurstDirectCall()
			{
				Constructor();
			}
	...
	internal struct SlabAllocator : IAllocator, IDisposable
	{
		...
		internal static class Try_000000B9_0024BurstDirectCall
		{
			...
			private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(Try_000000B9_0024PostfixBurstDelegate).TypeHandle);
				}
				P_0 = Pointer;
			}
			...
			static Try_000000B9_0024BurstDirectCall()
			{
				Constructor();
			}
	...
	public static void Initialize_0024StackAllocator_Try_000000AB_0024BurstDirectCall()
	{
		StackAllocator.Try_000000AB_0024BurstDirectCall.Initialize();
	}

	public static void Initialize_0024SlabAllocator_Try_000000B9_0024BurstDirectCall()
	{
		SlabAllocator.Try_000000B9_0024BurstDirectCall.Initialize();
	}
}
