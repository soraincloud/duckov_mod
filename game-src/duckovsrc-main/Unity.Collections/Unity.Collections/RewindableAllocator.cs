...
public struct RewindableAllocator : AllocatorManager.IAllocator, IDisposable
{
	...
	internal delegate int Try_000009DE_0024PostfixBurstDelegate(IntPtr state, ref AllocatorManager.Block block);

	internal static class Try_000009DE_0024BurstDirectCall
	{
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(Try_000009DE_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		static Try_000009DE_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	{
		return Try_000009DE_0024BurstDirectCall.Invoke(state, ref block);
	}
