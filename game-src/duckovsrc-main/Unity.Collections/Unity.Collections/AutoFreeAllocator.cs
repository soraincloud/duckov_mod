...
internal struct AutoFreeAllocator : AllocatorManager.IAllocator, IDisposable
{
	...
	internal static class Try_000000E3_0024BurstDirectCall
	{
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(Try_000000E3_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		static Try_000000E3_0024BurstDirectCall()
		{
			Constructor();
		}
