...
public static class xxHash3
{
	...
	internal unsafe delegate ulong Hash64Long_00000A73_0024PostfixBurstDelegate(byte* input, byte* dest, long length, byte* secret);

	internal static class Hash64Long_00000A73_0024BurstDirectCall
	{
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(Hash64Long_00000A73_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		static Hash64Long_00000A73_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	internal unsafe delegate void Hash128Long_00000A7A_0024PostfixBurstDelegate(byte* input, byte* dest, long length, byte* secret, out uint4 result);

	internal static class Hash128Long_00000A7A_0024BurstDirectCall
	{
		private static IntPtr Pointer;
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(Hash128Long_00000A7A_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		static Hash128Long_00000A7A_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	{
		return Hash64Long_00000A73_0024BurstDirectCall.Invoke(input, dest, length, secret);
	}
	...
	{
		Hash128Long_00000A7A_0024BurstDirectCall.Invoke(input, dest, length, secret, out result);
	}
