...
internal static class ModAssets
{
    ...
    {
        "splashhealingpotion_assets",
        "splashhealingpotion_assets.bundle",
        "splashhealingpotion_assets.unity3d"
    };

    private static readonly string[] HandheldAgentPrefabNames =
    {
        "SplashHealingPotion_HandheldAgent"
    };

    private static readonly string[] PickupAgentPrefabNames =
    {
        "SplashHealingPotion_PickupAgent"
    };

    // Simpler workflow: plain model prefabs (no game scripts required)
    private static readonly string[] HandheldModelPrefabNames =
    {
        "SplashHealingPotion_HandheldModel"
    };

    private static readonly string[] PickupModelPrefabNames =
    {
        "SplashHealingPotion_PickupModel"
    };

    private static readonly string[] FlyingModelPrefabNames =
    {
        "SplashHealingPotion_PickupModel",
        "SplashHealingPotion_HandheldModel"
    };
        ...
        try
        {
            ...
            switch (agent.AgentType)
            {
                case ItemAgent.AgentTypes.handheld:
                    modelNames = HandheldModelPrefabNames;
                    break;
                case ItemAgent.AgentTypes.pickUp:
                    modelNames = PickupModelPrefabNames;
                    break;
                default:
                    return;
            }
